...
{else}
	<div class="card-block-header">
		<span>{l s='Rooms & Amount Summarry'}</span>
	</div>
	...
	<div id="order-detail-content">
				...
				<div class="row cart_product_line">
					...
					<div class="col-sm-10">
						...
						<p class="room-features">
							<span>
								<img src="./themes/hotel-reservation-theme/img/icon/form-ok-circle.svg" /> {l s='Personal Vechile Parking'}
							</span>
							<span>
								<img src="./themes/hotel-reservation-theme/img/icon/form-ok-circle.svg" /> {l s='Personal Vechile Parking'}
							</span>
						...
						<div class="row">
							<div class="col-sm-6">
								...
								<p class="room_total_price_detial">
									Prices for 6 Nights stay (Excluded all taxes.)
								</p>
							</div>
							<div class="col-sm-6">
								<div class="unit_price_block pull-right">
									<p class="room_unit_price">
										<span class="real_price">$ 7000.00</span> {displayPrice price=$rm_v['amount']}<span>/Per Night<span>
									</p>
									<p class="room_unit_price_detail">You save {displayPrice price=$rm_v['amount']} per night</p>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="row">
			<div class="col-sm-12 proceed_btn_block">
				<a class="btn btn-default button button-medium pull-right" href="#" title="Proceed to checkout" rel="nofollow">
					<span>
						{l s='Proceed'}
					</span>
				</a>
